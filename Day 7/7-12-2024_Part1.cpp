...
long int evaluateExpression(const vector<long int>& numbers, const vector<char>& operators) {
...
bool canCalibrate(long int target, const vector<long int>& numbers, vector<char>& operators, size_t index) {
